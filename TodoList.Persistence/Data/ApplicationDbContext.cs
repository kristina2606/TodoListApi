    ...
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Todo>().HasData(
                ...
                new Todo { Id = 4, Title = "Plan Your Work Day", Description = "Create a task list for the day and prioritize them. This will help you organize your work and achieve your goals.", Status = Status.Todo, CreatedDate = DateTime.Now.AddMinutes(-80), UserId = "99" },
                ...
                new Todo { Id = 6, Title = "Lunch Break", Description = "Take a break and have lunch. Consider healthy eating, including vegetables, proteins, and healthy fats.", Status = Status.Todo, CreatedDate = DateTime.Now.AddDays(-3), UserId = "99" }
                );
        }
    }
}
